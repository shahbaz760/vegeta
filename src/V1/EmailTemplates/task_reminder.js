export const taskReminder = async (data) => {
                ...
                <tr>
                  <td>
                    <p class="otp" style="
                        ...
                        ">
                      <br />
                   <span style="color: rgba(17, 24, 39, 1); font-size:20px;font-weight: 400;">Project: </span> <span style="color: #757982; font-size:20px;font-weight: 600;"> ${data.project_name}</span><br>
                   <span style="color: rgba(17, 24, 39, 1); font-size:20px;font-weight: 400;">Title: </span> <span style="color: #757982; font-size:20px;font-weight: 600;"> ${data.title}</span><br>
                   <span style="color: rgba(17, 24, 39, 1); font-size:20px;font-weight: 400;">Due Date: </span> <span style="color: #757982; font-size:20px;font-weight: 600;"> ${data.due_date_time}</span><br>
                   <span style="color: rgba(17, 24, 39, 1);font-size:20px;font-weight: 400;">Description: </span> <span style="color: #757982;font-size:20px;font-weight: 600;"> ${data.description}</span><br>
