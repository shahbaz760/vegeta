export const resetPassword = async (resetPasswordLink) => {
            ...
            <tr>
              <td>
                ...
                <p style="
                      ...
                      margin-bottom: 0px;
                    ">
             Please find your reset password link below.
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                <h2 style="
                    ...
                    ">
                 Please click the reset password link to continue the process.
                </h2>
              </td>
            </tr>
          </table>
