export const cardExpiryReminder = async (data) => {
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                        ">
                        We hope you're well. We are writing to inform you that your card ending in ${data.last_digit} is set to expire on ${data.expire_date}. 
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                  ">
                    To ensure uninterrupted service, please update your payment details at your earliest convenience by following these steps:
                </p>
                ...
                <tr>
                  <td>
                    <h2 style="
                          ...
                          margin: 0px;
                        ">
                      If you need assistance updating your card, our support team is here to help.
                    </h2>
                    <p style="
                          font-style: normal;
                          font-weight: 400;
