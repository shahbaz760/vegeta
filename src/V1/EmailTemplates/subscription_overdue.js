export const subscriptionOverdue = async (data) => {
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                        ">
                    We noticed that your subscription payment for ${data.title} has not been received. As a result, your subscription status has been marked as overdue.
                    </p>
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                  ">
                  To continue enjoying our services without interruptions, please complete your payment as soon as possible.
                </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h2 style="
                          ...
                          margin: 0px;
                        ">
                      If you have already made the payment, kindly disregard this message. For assistance, please reach out to our support team.
                    </h2>
                    <p style="
                          font-style: normal;
                          font-weight: 400;
