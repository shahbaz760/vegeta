export const paymentSuccess = async (getClientInfo, invoiceUrl, docusignUrl) => {
            ...
            <tr>
                <td>
                  ...
                  >
                    ...
                    <br />
                    <span
                    style="display: block; background: #f7f9fb; width: 100%; height: 2px; margin :25px auto 23px;"
                  ></span>
                   
                    <span
                      style="font-size: 22px; color: #111827; font-weight: 500;"
                    >
                      Here is invoice link
                    </span>
                    <br />
                    <a
                      href="${invoiceUrl}"
            ...
            <tr>
              <td>
                <h2 style="
                    ...
                    ">
                Click the buttons above to sign your document and view the invoice.
                </h2>
              </td>
            </tr>
          </table>
