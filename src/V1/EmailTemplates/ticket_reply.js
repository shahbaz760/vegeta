export const ticketReply = async (data, reply, roleId) => {
              ...
              <table style="
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                        ...
                        if(roleId == 1) {
                          result+= `Thank you for reaching out to us. Please check new reply on ticket: ${data.id}`;
                        }else {
                          result+= `Please check new reply on ticket: ${data.id}`;
                        }
                ...
                <tr>
                  <td>
                   ...
                   <span style="color: rgba(17, 24, 39, 1);font-size:20px;font-weight: 400;">Reply: </span> <span style="color: #757982;font-size:20px;font-weight: 600;"> ${reply}</span><br>
                    </span>
                  </td>
                </tr>
              </table>
