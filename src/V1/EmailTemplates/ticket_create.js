export const ticketCreate = async (data) => {
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                          ...
                          margin-bottom: 0px;
                        ">
                        A new support ticket has been submitted by ${data.user_name}. Please find the details below:
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                   ...
                   <span style="color: rgba(17, 24, 39, 1); font-size:20px;font-weight: 400;">Subject: </span> <span style="color: #757982; font-size:20px;font-weight: 600;"> ${data.subject}</span><br>
                   ...
                   <span style="color: rgba(17, 24, 39, 1);font-size:20px;font-weight: 400;">Message: </span> <span style="color: #757982;font-size:20px;font-weight: 600;"> ${data.message}</span><br>
                    </span>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h2 style="
                        ...
                        ">
                      Please review the ticket and respond to the user as soon as possible.
                    </h2>
                  </td>
                </tr>
              </table>
