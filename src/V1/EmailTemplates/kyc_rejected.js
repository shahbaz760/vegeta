export const kycRejected = async (data) => {
          ...
          <tr>
            <td>
              <table style="
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                        ">
                        We regret to inform you that your KYC submission has been rejected due to the following reason(s):
                    </p>
                    ...
                    <p style="
                      ...
                      margin-bottom: 0px;
                  ">
                    <b>Rejection Reason:</b> ${data.reject_reason}
                ...
                margin-bottom: 0px;
            ">
               To complete the process, please update your KYC information and resubmit your request. Follow these steps:
             </p>
              ...
              <p style="
                  ...
                  <h2 style="
                    ...
                    margin-left: 68px;
                  ">
                    2. Update the required information as per the rejection reason.
                  </h2>
                  <h2 style="
                    font-weight: 400;
                    font-size: 20px;
                    ...
                    margin-left: 68px;
                ">
                  3. Submit your KYC request again.
                </h2>
              </p>
                  </td>
                </tr>
