export const updateLoginDetails = async (login_detail) => {
                ...
                <tr>
                  <td>
                    ...
                    <p style="
                          ...
                          margin-bottom: 0px;
                        ">
                  Please check below your login details.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p class="otp" style="
                        ...
                        ">
                      <span style="font-size: 20px; color: #111827; font-weight: 500;line-height:2;">
                     Your password is updated, here is your new login details.
                     </span>
                      <br />
                   <span style="color:#757982;font-size:20px;font-weight: 400;">Email:</span> <span style="font-size:20px;font-weight: 600;">${login_detail.email}</span><br>
                   <span style="color:#757982;font-size:20px;font-weight: 400;"> Password: </span><span style="font-size:20px;font-weight: 600;">${login_detail.password}</span>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h2 style="
                        ...
                        ">
Please check your email address, along with your secure password.
                    </h2>
                  </td>
                </tr>
              </table>
